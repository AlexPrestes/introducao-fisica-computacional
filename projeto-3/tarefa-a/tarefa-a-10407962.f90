program tarefaa
    ...
    do i = 1, 14
        ...
        write(10,*) h(i), abs(dfrente2p_x_h-df_x), abs(dtras2p_x_h-df_x), abs(dsimetrica3p_x_h-df_x), abs(dsimetrica5p_x_h-df_x), abs(d2simetrica5p_x_h-d2f(x)), abs(d3antisimetrica5p_x_h-d3f(x))
    end do
